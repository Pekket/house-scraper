package be.pekket.housescraper.immoscoop.service;

import be.pekket.housescraper.exception.ScraperException;
import be.pekket.housescraper.immoscoop.connector.ImmoscoopConnector;
import be.pekket.housescraper.immoscoop.mapper.ImmoscoopMapper;
